...
object FeatureHasherData {
  ...
  val expectedResults = List(
    ...
    32 -> List(
      ...
      SparseVector.fromCOO(32, Map(2 -> -1.0 ,11 -> -1.0 ,17 -> -1.0 ,18 -> 1.0 ,19 -> 1.0 ,20 -> 2.0 ,31 -> -1.0)),
      ...
      SparseVector.fromCOO(32, Map(0 -> 1.0 ,1 -> 1.0 ,2 -> 1.0 ,4 -> -1.0 ,17 -> -1.0 ,30 -> -2.0 ,31 -> 0.0))),
    1234 -> List(
      SparseVector.fromCOO(1234, Map(86 -> -1.0 ,154 -> 1.0 ,575 -> -1.0 ,666 -> 1.0 ,900 -> 1.0 ,1229 -> 1.0)),
      SparseVector.fromCOO(1234, Map(47 -> -1.0 ,132 -> 2.0 ,214 -> 1.0 ,323 -> -1.0 ,1039 -> 0.0 ,1192 -> -1.0)),
      SparseVector.fromCOO(1234, Map(387 -> 1.0 ,414 -> 1.0 ,457 -> 1.0 ,536 -> 1.0 ,809 -> 1.0 ,894 -> -1.0 ,1020 -> 1.0)),
      SparseVector.fromCOO(1234, Map(372 -> -1.0 ,549 -> -1.0 ,829 -> -2.0 ,848 -> -1.0 ,866 -> -1.0 ,949 -> 1.0)),
      SparseVector.fromCOO(1234, Map(80 -> -1.0 ,388 -> 1.0 ,541 -> -1.0 ,592 -> -1.0 ,809 -> 1.0 ,916 -> 1.0 ,1190 -> -1.0 ,1211 -> -1.0 ,1229 -> 1.0))),
    65536 -> List(
      SparseVector.fromCOO(65536, Map(17938 -> -1.0 ,19160 -> 1.0 ,26330 -> 1.0 ,32544 -> 1.0 ,40055 -> -1.0 ,44023 -> 1.0)),
      SparseVector.fromCOO(65536, Map(15362 -> -1.0 ,21483 -> -1.0 ,40338 -> 1.0 ,44241 -> -1.0 ,46239 -> -1.0 ,46900 -> 1.0 ,52403 -> 1.0 ,52980 -> 1.0)),
      SparseVector.fromCOO(65536, Map(34447 -> 1.0 ,36513 -> 1.0 ,51364 -> 1.0 ,53192 -> 1.0 ,56748 -> -1.0 ,57640 -> 1.0 ,58001 -> 1.0)),
      SparseVector.fromCOO(65536, Map(11467 -> -1.0 ,17394 -> -1.0 ,18484 -> -1.0 ,47906 -> -1.0 ,61309 -> -2.0 ,63041 -> 1.0)),
      SparseVector.fromCOO(65536, Map(2848 -> 1.0 ,9407 -> -1.0 ,11441 -> -1.0 ,15652 -> -1.0 ,17438 -> -1.0 ,18786 -> 1.0 ,32575 -> 1.0 ,36513 -> 1.0 ,63230 -> -1.0))),
    1048576 -> List(
      SparseVector.fromCOO(1048576, Map(98080 -> 1.0 ,629879 -> -1.0 ,895991 -> 1.0 ,943834 -> 1.0 ,1000978 -> -1.0 ,1002200 -> 1.0)),
      SparseVector.fromCOO(1048576, Map(15362 -> -1.0 ,283627 -> -1.0 ,373919 -> -1.0 ,765137 -> -1.0 ,838835 -> 1.0 ,898868 -> 1.0 ,904948 -> 1.0 ,957842 -> 1.0)),
      SparseVector.fromCOO(1048576, Map(122284 -> -1.0 ,385681 -> 1.0 ,575652 -> 1.0 ,757409 -> 1.0 ,774088 -> 1.0 ,909608 -> 1.0 ,951951 -> 1.0)),
      SparseVector.fromCOO(1048576, Map(149556 -> -1.0 ,244514 -> -1.0 ,521793 -> 1.0 ,651133 -> -2.0 ,994507 -> -1.0 ,1000434 -> -1.0)),
      SparseVector.fromCOO(1048576, Map(84322 -> 1.0 ,212260 -> -1.0 ,402623 -> -1.0 ,535729 -> -1.0 ,653054 -> -1.0 ,757409 -> 1.0 ,985888 -> 1.0 ,1000478 -> -1.0 ,1015615 -> 1.0)))
  ) toMap
