...
public class ParquetProtobufOutput2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ParsedPageProtos.ParsedPage.Builder builder2 = ParsedPageProtos.ParsedPage.newBuilder();
        builder2.setUrl("www.bad.de").setArchiveTime(123L);

        List l = Arrays.asList(new Tuple2<Void,ParsedPageProtos.ParsedPage>(null, builder.build()), 
                new Tuple2<Void,ParsedPageProtos.ParsedPage>(null, builder2.build()));
