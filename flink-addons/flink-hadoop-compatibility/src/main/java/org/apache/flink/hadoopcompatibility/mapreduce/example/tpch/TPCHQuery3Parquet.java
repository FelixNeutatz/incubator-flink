...
public class TPCHQuery3Parquet {
	...
	private static DataSet<Tuple2<Void, CustomerTable>> getCustomerDataSet(ExecutionEnvironment env) throws IOException {
		...
		HadoopInputFormat hadoopInputFormat = new HadoopInputFormat(new ParquetThriftInputFormat(), Void.class, CustomerTable.class, job);

		// Filter market segment "AUTOMOBILE"
		ParquetThriftInputFormat.setUnboundRecordFilter(job, CustomerFilter.class);
	...
	private static DataSet<Tuple2<Void, OrderTable>> getOrdersDataSet(ExecutionEnvironment env) throws IOException {
		...
		HadoopInputFormat hadoopInputFormat = new HadoopInputFormat(new ParquetThriftInputFormat(), Void.class, OrderTable.class, job);
	...
	public static class Order extends Tuple4<Long, Long, String, Integer> {
		...
		public String getOrderdate() { return this.f2; }
		public int getShippriority() { return this.f3; }
	}
